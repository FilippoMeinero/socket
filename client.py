...
udp_client_socket = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)    # AF_INET --> ipV4
                                                                        # DGRAM --> protocollo UDP

message = "CIAO DA CLIENT"
try:
    udp_client_socket.sendto(message.encode(), server_address) # codifica il messaggio
